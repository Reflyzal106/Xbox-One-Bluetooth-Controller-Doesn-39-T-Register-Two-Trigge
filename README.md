# [SOLVED] Xbox-One-Bluetooth-Controller-Doesn-39-T-Register-Two-Trigge
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/xbox-one-bluetooth-controller-doesn-39-t-register-two-trigge)
>
...
Try updating the Xbox One controller drivers and enabling the 'Use Absolute Deadzone' setting in the game's controller settings.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/xbox-one-bluetooth-controller-doesn-39-t-register-two-trigge)**
